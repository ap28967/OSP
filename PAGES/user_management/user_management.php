...
<?php 
    $query_profil = mysqli_query($link_osp, "SELECT * FROM view_sesi WHERE npk = '$_SESSION[osp_user]'") or die(mysqli_error($link_osp));
    ...
    <div class="col-md-4">
        <div class="card" style="height:300px; border-radius:20px; background-image:url('../../ASSETS/img/damir-bosnjak.jpg');" >
            <div class="row d-flex justify-content-center">
                ...
                <div class="card-body col-md-12 d-flex justify-content-center" style="padding:0px;"><h5><?php echo $profil['nama'];?></h5></div>
                <div class="card-body col-md-12 d-flex justify-content-center" style="padding:0px;"><p><?php echo $profil['jabatan_full'];?></p></div>       
            </div>
        </div>
        <div>
            <div class="card" style="background-color:white;  border-radius:20px;">
                <div class="row d-flex justify-content-center" style="padding: 20px;">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="tampil_npk" class="form-control" disabled value="<?php echo $profil['npk'];?>">
                        </div>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="tampil_level" class="form-control" disabled value="<?php echo $profil['role_name'];?>">
                        </div>
                        </div>
        ...
        <div class="card"  style="border-radius:20px; padding:20px; border-radius:20px;">
            ...
            <div class="row  ">
                <div class="form-group col-md-4">
                    ...
                    <input id="division" type="text" class="form-control" value="<?php echo $profil['nama_divisi'];?>" disabled>
                </div>
                <div class="form-group col-md-4">
                    <label for="dept_account">Department Account  </label>
                    <input id="dept_account" type="text" class="form-control" value="<?php echo $profil['nama_dept_account'];?>" disabled>
                </div>
                <div class="form-group col-md-4">
                    <label for="dept">Department  </label>
                    <input id="dept" type="text" class="form-control" value="<?php echo $profil['nama_dept'];?>" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label for="sect">Section  </label>
                    <input id="sect" type="text" class="form-control" value="<?php echo $profil['nama_sect'];?>" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label for="grp">Group  </label>
                    <input id="grp" type="text" class="form-control" value="<?php echo $profil['nama_grp'];?>" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label for="pos_kerja">Pos Kerja  </label>
                    <input id="pos_kerja" type="text" class="form-control" value="<?php echo $profil['post'];?>" disabled>
                </div>
                <div class="form-group col-md-3">
                    <label for="shift">Shift  </label>
                    <input id="shift" type="text" class="form-control" value="<?php echo $profil['shift'];?>" disabled>
                </div>
            </div>
            ...
            <div class="row  ">
                <div class="form-group col-md-6">
                    ...
                    <input id="nama_lengkap" type="text" class="form-control" value="<?php echo $profil['nama'];?>" disabled>
                </div>
                <div class="form-group col-md-6">
                    <label for="nama_panggilan">Nama Panggilan</label>
                    <input id="nama_panggilan" type="text" class="form-control" value="<?php echo $profil['nama_depan'];?>" disabled>
                </div>
                <div class="form-group col-md-4">
                    <label for="status_karyawan">Status Karyawan</label>
                    <input id="status_karyawan" type="text" class="form-control" value="<?php echo $profil['status'];?>" disabled>
                </div>
                <div class="form-group col-md-4">
                    <label for="tgl_masuk">Tanggal Masuk  </label>
                    <input id="tgl_masuk" type="text" class="form-control" value="<?php echo date('d/m/Y',strtotime($profil['tgl_masuk']));?>" disabled>
                </div>
                <div class="form-group col-md-4">
                    <label for="masa_kerja">Masa Kerja  </label>
                    <input id="masa_kerja" type="text" class="form-control" value="<?php echo date('Y',time())-(int)$profil['tgl_masuk'].' Tahun';?>" disabled>
                </div>
                <div class="form-group col-md-6">
                    <label for="tempat_lahir">Kota Tempat Lahir  </label>
                    <input id="tempat_lahir" type="text" class="form-control" value="" placeholder=". . .">
                </div>
                <div class="form-group col-md-6">
                    <label for="tgl_lahir">Tanggal Lahir  </label>
                    <input id="tgl_lahir" type="date" class="form-control" value="" placeholder="date">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea id="alamat_domisili" type="text" class="form-control" value="" placeholder=". . . " style="height:80px;"></textarea>
                </div>
            </div>
